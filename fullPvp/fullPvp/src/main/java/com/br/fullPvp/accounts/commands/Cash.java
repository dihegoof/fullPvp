...
public class Cash extends Utils implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		if(sender instanceof Player) { 
			...
			if(args.length == 0) { 
				sendMessage(sender, true, "§aSeu cash: §7" + TypeCoin.formatExactFormatter(TypeCoin.CASH, account.getCash()));
				return true;
